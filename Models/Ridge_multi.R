...
RidgeMultiModel <- function(data_for_class_1_train, 
  ...
  for(i in 1:100){
    ...
    model_lasso_1 <- cv.glmnet(x = binary_data, y = binary_results, family = "binomial", alpha = 0, standardize = TRUE, type.measure = "class")
    ...
    model_lasso_2 <- cv.glmnet(x = binary_data, y = binary_results, family = "binomial", alpha = 0, standardize = TRUE, type.measure = "class")
    ...
    model_lasso_3 <- cv.glmnet(x = binary_data, y = binary_results, family = "binomial", alpha = 0, standardize = TRUE, type.measure = "class")
