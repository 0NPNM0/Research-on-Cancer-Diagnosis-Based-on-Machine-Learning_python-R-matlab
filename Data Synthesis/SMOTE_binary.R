...
SMOTEBinaryFunction <- function(dap_class){
  ...
  syn_data_1 <- SMOTE(original_X1, original_Y1, K = 5, dup_size = 1)#使用SMOTE算法合成数据
  ...
  class_data_1 <- class_data_1[1:70,]#只拿70个样本
  ...
  syn_data_0 <- SMOTE(original_X0, original_Y0, K = 5, dup_size = 3)#使用SMOTE算法合成数据
  ...
  class_data_0 <- class_data_0[1:210,]#只拿210个样本
